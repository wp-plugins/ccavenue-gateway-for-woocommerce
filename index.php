    ...
    class WC_cc extends WC_Payment_Gateway
    {
        ...
        function check_ccavenue_response()
        {
            ...
            if ($order_id != '') {
                ...
                else if($veriChecksum==TRUE && $AuthDesc==="N")
                {
                    ...
                    $order->add_order_note('CCAvenue payment successful<br/>Bank Reference Number: ' . $bank_ref);
                    $woocommerce->cart->empty_cart();
                }
                else
                {
        ...
        public function generate_ccavenue_form($order_id)
        {
            ...
            $ccavenue_args = array(
                ...
                'Checksum' => getchecksum($this->merchant_id, $order->order_total, $order_id, $this->notify_url, $this->working_key)
            );
